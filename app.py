...
# chroma_client = chromadb.PersistentClient(path="images1.chromadb")
chroma_client = chromadb.PersistentClient(path="images2.chromadb")


# collection = chroma_client.get_collection(name="images")
collection = chroma_client.get_collection(name="images2")
